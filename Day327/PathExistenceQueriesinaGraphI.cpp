...
// // nums[1]| = |1 - 3| = 2, which is greater than maxDiff. Thus, the final
// answer
// // after processing all the queries is [true, false]. Example 2:
...
// // Query [0,1]: There is no edge between Node 0 and Node 1 because |nums[0] -
// // nums[1]| = |2 - 5| = 3, which is greater than maxDiff. Query [0,2]: There
// is
// // no edge between Node 0 and Node 2 because |nums[0] - nums[2]| = |2 - 6| =
// 4,
// // which is greater than maxDiff. Query [1,3]: There is a path between Node 1
// // and Node 3 through Node 2 since |nums[1] - nums[2]| = |5 - 6| = 1 and
// // |nums[2] - nums[3]| = |6 - 8| = 2, both of which are within maxDiff. Query
// // [2,3]: There is an edge between Node 2 and Node 3 because |nums[2] -
// nums[3]|
// // = |6 - 8| = 2, which is equal to maxDiff. Thus, the final answer after
// // processing all the queries is [false, false, true, true].
