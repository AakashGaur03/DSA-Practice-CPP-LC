...
// };
// // 1st Approach
// // Traverse One store everything
// // traverse second check if matches at any place if yes then return Node
// // TC O(m+n)
// // SC O(N)

// // 2nd Approach
// // Traverse both simultaneously when head 1 reaches null point to head 2
// // similarly
// //  when head 2 reaches null point to head 2
// // compare both if they reaches hed 1 == head 2 return
// // means they have either met at intersection point or at Null that is last
// // TC O(m+n)
// // SC O(1)