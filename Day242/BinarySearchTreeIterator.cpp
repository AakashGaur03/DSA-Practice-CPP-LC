...
// // pointer to the right, then returns the number at the pointer. Notice that
// by
// // initializing the pointer to a non-existent smallest number, the first call
// to
...
//         // Push All Left Descendents so that smallest element stays on top
//         pushAll(root);
//     }
...
//         // If this Node has a right Subtree then push all its left descendent
