...
// // range [-3 * 104, 3 * 104]. For operation "+", there will always be at
// least
// // two previous scores on the record. For operations "C" and "D", there will
// // always be at least one previous score on the record.
