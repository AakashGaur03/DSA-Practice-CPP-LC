...
// class Solution {
// public:
//     int maxPathSumFunc(TreeNode* root, int &maxi) {

//         if (root == nullptr) {
//             return 0;
//         }
//         int leftSum = max(0, maxPathSumFunc(root->left, maxi));
//         int rightSum = max(0, maxPathSumFunc(root->right, maxi));
...
//         int maxi = INT_MIN;
//         int res = maxPathSumFunc(root, maxi);
//         return maxi;
//     }
// };