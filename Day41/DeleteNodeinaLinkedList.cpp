...
//         // Overwrite current value of node
//         node->val = node->next->val;
//         // Disconnect next in LL
//         // Skip the next node (unlink it)
//         node->next = node->next->next;
//     }
// };
// // Ex 1->2->3->4
// // we are give 2 to remove
// // so first we are doing
// // 1->3->3->4
// // Second
// // 1->3->4
// // that second 3 also exist as in question we are told not to remove from
// memory
// // so we just replace it with its next and remove connection of it
