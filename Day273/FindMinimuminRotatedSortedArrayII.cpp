...
// So instead of discarding half the array, you do:

// low++;
// high--;

// That reduces the search space by only 2 elements, not half.

// So in the worst case, the algorithm behaves like linear search:

// Worst case O(n) due to ambiguous duplicate cases.