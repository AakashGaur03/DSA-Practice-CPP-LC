...
// three
// // integers sr, sc, and color. Your task is to perform a flood fill on the
// image
...
// vertically)
// // and shares the same color as the starting pixel. Keep repeating this
// process
...
// // stops when there are no more adjacent pixels of the original color to
// update.
