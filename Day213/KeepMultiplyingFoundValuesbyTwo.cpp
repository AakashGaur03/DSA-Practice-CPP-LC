...
// // original). Otherwise, stop the process. Repeat this process with the new
// // number as long as you keep finding the number. Return the final value of
// // original.
...
//     // TC O(N log N + N)
//     // SC O(1)
//     // we can sort and iterate it once only
...
//         // count() checks whether an element exists in the set.
