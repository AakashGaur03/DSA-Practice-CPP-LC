...
//     Node* pointCorrectRandomPointers(Node* head) {
//         Node* temp = head;
...
//     Node* pointCorrectNextPointers(Node* head) {
//         Node* temp = head;
...
//         // We will target This question in three steps
//         // Insert Copy Node in Between
//         head = insertCopyNode(head);
//         // Point to correct Random Pointers
//         head = pointCorrectRandomPointers(head);
//         // Point to correct Next pointers with Correct Original array
//         return pointCorrectNextPointers(head);
//     }
// };