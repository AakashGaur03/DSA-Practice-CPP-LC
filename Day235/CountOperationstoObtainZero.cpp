...
// one
// // operation, num1 = 4 and num2 = 1. Return the number of operations required
// to
...
// from
// // num1. Now num1 = 0 and num2 = 1. Since num1 == 0, we do not need to
// perform
...
// // from num1 and get num1 = 10 - 10 = 0. Now num1 = 0 and num2 = 10. Since
// num1
