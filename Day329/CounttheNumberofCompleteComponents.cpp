...
// path
// // between any two vertices, and no vertex of the subgraph shares an edge
// with a
...
// components
// // of this graph are complete. Example 2:

// // Input: n = 6, edges = [[0,1],[0,2],[1,2],[3,4],[3,5]]
// // Output: 1
// // Explanation: The component containing vertices 0, 1, and 2 is complete
// since
// // there is an edge between every pair of two vertices. On the other hand,
// the
