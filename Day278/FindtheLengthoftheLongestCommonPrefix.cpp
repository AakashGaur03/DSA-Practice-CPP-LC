...
// // prefix of both a and b. For example, 5655359 and 56554 have common
// prefixes
...
//         // arr1Prefixes.count(val) Gives us count how many occurance is
//         present
//         // in set if 1 present then 1 if not present then 0

//         for (int val : arr1) {
//             while (!arr1Prefixes.count(val) && val > 0) {
//                 // Insert current value as a prefix
//                 arr1Prefixes.insert(val);
//                 // Generate the next shorter prefix by removing the last
//                 digit val /= 10;
//             }
//         }
