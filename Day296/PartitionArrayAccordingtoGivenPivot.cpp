...
// // new position of the jth element. If i < j and both elements are smaller
// (or
...
// side
// // of the array. The elements 12 and 14 are greater than the pivot so they
// are
...
// // than pivot is also maintained. [-3] and [4, 3] are the respective
// orderings.
