...
// class Solution {
// public:
//     ListNode* startingPoint(ListNode* slow, ListNode* fast, ListNode* head) {
//         slow = head;
...
//             fast = fast->next;
//         }
//         return slow; // will coldide again at starting point only
//     }
...
//             fast = fast->next->next;
//             slow = slow->next;
//             if (slow == fast) { // means they have collided so loop exist
