...
// mass of the asteroid, the asteroid is destroyed and the planet gains the mass
// of the asteroid. Otherwise, the planet is destroyed.
...
// mass of 23.
// // After the planet destroys the other asteroids, it will have a mass of 5 +
// 4 + 9 + 4 = 22.
...
//             if (asteroids[i] > massAdded) {
//                 return false;
//             } else {
//                 massAdded += asteroids[i];
//             }
//         }
//         return true;
//     }
