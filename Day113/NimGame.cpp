...
// the
// // heap. The one who removes the last stone is the winner. Given n, the
// number
// // of stones in the heap, return true if you can win the game assuming both
// you
...
//         // Basically it is a trick question
//         // We can only win if stone is 1 2 3 if there are 4 stones we always
//         lose
//         // so 5 6 7 we win 8 we loose ...
//         return n%4;
//     }
// };