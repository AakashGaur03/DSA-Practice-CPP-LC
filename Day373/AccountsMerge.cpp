...
// // even if two accounts have the same name, they may belong to different
// people
// // as people could have the same name. A person can have any number of
// accounts
...
// email
// // "johnsmith@mail.com". The third John and Mary are different people as none
// of
// // their email addresses are used by other accounts. We could return these
// lists
...
//         // Step 2
//         // Mer<ge the Mails acc to List Ultimate Parents
//         vector<vector<string>> mergedMail(n);
//         for (auto it : mapMailNode) {
//             string mail = it.first;
//             int node = ds.findUPar(
//                 it.second); // This gives us ULtimate Parent of Mapped Node
//             mergedMail[node].push_back(mail);
//         }

//         // Step 3 get the correct Answer as in Step 2 there can be Empty
//         Indexes
//         // too also we need to sort the mails
...
//             vector<string> temp;
//             temp.push_back(accounts[i][0]); // Names
